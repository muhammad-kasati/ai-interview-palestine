...
export const metadata: Metadata = {
  title: 'Mentor Earnings & Financial Analytics',
  description: 'Review income, monthly revenue trends, and session financial statistics.',
};
...
export default async function MentorEarningsPage() {
  ...
  return (
    <MentorEarningsClient
      hourlyRate={Number(mentor.hourly_rate_usd ?? 0)}
      bookings={bookings ?? []}
    />
  );
}
