...
export default function LoginPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    // Role-based redirect happens in middleware, just push to dashboard
  ...
  return (
    <div className="min-h-screen bg-grid flex items-center justify-center p-4" style={{ background: 'radial-gradient(ellipse 80% 60% at 50% -10%, rgba(0,255,102,0.06) 0%, transparent 60%), var(--bg-base)' }}>
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p style={{ color: 'var(--text-secondary)' }}>Sign in to continue your interview prep</p>
        </div>
        ...
        <div className="glass rounded-2xl p-8" style={{ border: '1px solid rgba(255,255,255,0.08)' }}>
          ...
          <p className="text-center mt-6 text-sm" style={{ color: 'var(--text-secondary)' }}>
            ...
            <Link href="/signup" className="font-semibold transition-colors" style={{ color: 'var(--neon-green)' }}>
              Create one free
            </Link>
          </p>
        </div>
