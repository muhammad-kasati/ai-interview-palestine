    ...
    <div className="min-h-screen bg-grid flex items-center justify-center p-4" style={{ background: 'radial-gradient(ellipse 80% 60% at 50% -10%, rgba(0,229,255,0.06) 0%, transparent 60%), var(--bg-base)' }}>
      <div className="w-full max-w-md">
        ...
        <div className="glass rounded-2xl p-8">
          ...
          {/* Role Selection */}
          <div className="mb-6">
            <p className="text-sm font-medium mb-3" style={{ color: 'var(--text-secondary)' }}>I am joining as a</p>
            <div className="grid grid-cols-2 gap-3">
              {[
                { value: 'candidate' as Role, label: 'Candidate', desc: 'Preparing for interviews', Icon: User },
                { value: 'mentor' as Role, label: 'Mentor', desc: 'Coaching engineers', Icon: Briefcase },
                ...
                <button
                  ...
                  style={{
                    ...
                    border: role === value ? '1px solid rgba(0,255,102,0.4)' : '1px solid rgba(255,255,255,0.08)',
                    cursor: 'pointer',
                  }}
                >
                  <Icon className="w-5 h-5 mb-2" style={{ color: role === value ? 'var(--neon-green)' : 'var(--text-muted)' }} />
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl mb-6 transition-all"
            style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', color: 'var(--text-primary)', cursor: 'pointer' }}
          >
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button type="button" onClick={() => setShowPw(!showPw)} className="absolute right-3 top-1/2 -translate-y-1/2" style={{ color: 'var(--text-muted)', cursor: 'pointer' }}>
            ...
            <button id="btn-signup-submit" type="submit" disabled={loading} className="btn-neon-green w-full justify-center" style={{ opacity: loading ? 0.7 : 1 }}>
